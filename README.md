...
## Features
- Built using pure HTML (no CSS)
- Sections include About, Skills, Experience, Projects, Education, and Contact
- Clean and readable structure using semantic HTML tags
